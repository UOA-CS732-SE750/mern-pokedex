    ...
    <div className="pokedex-container">
      ...
      <div className="pokemon-list">
        ...
        <div className="search-container">
          <select className="generation-filter">
          ...
          <input type="text" className="search-box" placeholder="Search Pokemon..." />
        </div>

        {/* Pokemon list */}
        <div className="pokemon-list-items">

          {/* Individual Pokemon list item */}
          ...
          <div className="pokemon-item active">
      ...
      <div className="pokemon-details">
        ...
        <div className="pokemon-image-container">
          ...
          <img src="/assets/images/pokemon/149.png" alt="Dragonite" className="pokemon-image normal-image" id="pokemon-image" />
          <img src="/assets/images/pokemon/149-shiny.png" alt="Shiny Dragonite" className="pokemon-image shiny-image" />
        </div>
        ...
        <div className="pokemon-types">
          ...
          <span className="type-badge dragon">
            <img src="/assets/images/type-icons/type-icon-dragon.png" alt="Dragon" />
            Dragon
          </span>
          
          <span className="type-badge flying">
            <img src="/assets/images/type-icons/type-icon-flying.png" alt="Flying" />
            Flying
          </span>
        </div>
        ...
        <div className="pokemon-description">
          <h3>Pokedex Entry</h3>
          <p>An extremely rarely seen marine Pokémon. Its intelligence is said to match that of humans. It is able to freely control the weather, and is said to live in the sea.</p>
        </div>
      </div>
    </div>
  );
